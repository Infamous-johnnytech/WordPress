                    ...
                    <div class="info-action-wp">
                        <div class="property-detailes">
                            ...
                            <div class="detail p-add-date">
                                ...
                                <span class="value" title="<?php echo __('Visited times', 'real-estate-listing-realtyna-wpl').' : '.wpl_property::get_property_stats_item($property['data']['id'], 'visit_time'); ?>"><?php echo $property['data']['add_date']; ?></span>
                            </div>
                            ...
                            <?php if( $property['data']['expired'] ): ?>
                            <div class="expire-msg" id="pmanager_expired_status<?php echo $property['data']['id']; ?>">
                                <span>
									<?php echo __('Expired', 'real-estate-listing-realtyna-wpl'); ?> 
									<a href="javascript:void(0)" onclick="return wpl_revert_expire( this.id );" id="revert_<?php echo $property['data']['id']; ?>" data-id="<?php echo $property['data']['id']; ?>"><?php echo __('Click here to revert it!', 'real-estate-listing-realtyna-wpl'); ?></a> 
								</span>								
                            </div>
                            <?php endif; ?>
