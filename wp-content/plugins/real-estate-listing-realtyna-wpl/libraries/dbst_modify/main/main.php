...
$kind_table = wpl_flex::get_kind_table($kind);
?>
<div class="fanc-row">
    ...
    <input type="hidden" name="<?php echo $__prefix; ?>table_name" id="<?php echo $__prefix; ?>table_name" value="<?php echo $kind_table; ?>" />
</div>
<div class="fanc-row">
...
<div class="fanc-row">
    <label for="<?php echo $__prefix; ?>storage"><?php echo __('Storage', 'real-estate-listing-realtyna-wpl'); ?></label>
    <select class="wpl-storage-method" name="<?php echo $__prefix; ?>storage" id="<?php echo $__prefix; ?>storage">
        <option value="wpl_properties2" <?php if(isset($values->table_name) and $values->table_name == 'wpl_properties2') echo 'selected="selected"'; ?>><?php echo __('Normal Storage', 'real-estate-listing-realtyna-wpl'); ?></option>
        <option value="wpl_properties" <?php if(isset($values->table_name) and $values->table_name == 'wpl_properties') echo 'selected="selected"'; ?>><?php echo __('Search-able Storage', 'real-estate-listing-realtyna-wpl'); ?></option>
    </select>
</div>
<?php endif; ?>
...
<div class="fanc-row">
    <label for="<?php echo $__prefix; ?>savesearch"><?php echo __('Save Search', 'real-estate-listing-realtyna-wpl'); ?></label>
    <select name="<?php echo $__prefix; ?>savesearch" id="<?php echo $__prefix; ?>savesearch">
        <option value="1" <?php if (isset($values->savesearch) and $values->savesearch == '1') echo 'selected="selected"'; ?>><?php echo __('Show', 'real-estate-listing-realtyna-wpl'); ?></option>
        <option value="0" <?php if (isset($values->savesearch) and $values->savesearch == '0') echo 'selected="selected"'; ?>><?php echo __('Hide', 'real-estate-listing-realtyna-wpl'); ?></option>
    </select>
</div>
<?php endif; ?>
...
<div class="fanc-row" id="multisite_modify_status_container">
    ...
    <select name="multisite_modify_status" id="multisite_modify_status">
        <option value="0" <?php if (isset($values->multisite_modify_status) and $values->multisite_modify_status == '0') echo 'selected="selected"'; ?>><?php echo __('No', 'real-estate-listing-realtyna-wpl'); ?></option>
        <option value="1" <?php if (isset($values->multisite_modify_status) and $values->multisite_modify_status == '1') echo 'selected="selected"'; ?>><?php echo __('Yes', 'real-estate-listing-realtyna-wpl'); ?></option>
    </select>
</div>
<?php endif; ?>
