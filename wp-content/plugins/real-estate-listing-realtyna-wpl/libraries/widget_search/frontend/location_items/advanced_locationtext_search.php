...
if($show == 'advanced_locationtextsearch' and !$done_this)
{
	...
	$html .= '<input class="wpl_search_widget_location_textsearch" value="'.esc_attr($current_value).'" name="'.$element_id.'" id="'.$element_id.'" placeholder="'.__($placeholder, 'real-estate-listing-realtyna-wpl').'" />';
