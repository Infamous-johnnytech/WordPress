...
<div class="wpl_contact_container wpl_user_contact_container" id="wpl_user_contact_container<?php echo $this->activity_id; ?><?php echo $this->user_id; ?>">
	...
	<form method="post" action="#" id="wpl_user_contact_form<?php echo $this->activity_id; ?><?php echo $this->user_id; ?>" onsubmit="return wpl_send_user_contact<?php echo $this->activity_id; ?>('<?php echo $this->user_id; ?>');">
        <div class="form-field text-field">
            <input class="text-box" type="text" id="wpl_user_contact_fullname<?php echo $this->activity_id; ?><?php echo $this->user_id; ?>" name="fullname" placeholder="<?php echo __('Full Name', 'real-estate-listing-realtyna-wpl'); ?>" />
        </div>

        <div class="form-field text-field">
            <input class="text-box" type="text" id="wpl_user_contact_phone<?php echo $this->activity_id; ?><?php echo $this->user_id; ?>" name="phone" placeholder="<?php echo __('Phone', 'real-estate-listing-realtyna-wpl'); ?>" />
        </div>

        <div class="form-field text-field">
            <input class="text-box" type="text" id="wpl_user_contact_email<?php echo $this->activity_id; ?><?php echo $this->user_id; ?>" name="email" placeholder="<?php echo __('Email', 'real-estate-listing-realtyna-wpl'); ?>" />
        </div>

        <div class="form-field text-area">
            <textarea class="text-box" id="wpl_user_contact_message<?php echo $this->activity_id; ?><?php echo $this->user_id; ?>" name="message" placeholder="<?php echo __('Message', 'real-estate-listing-realtyna-wpl'); ?>"></textarea>
        </div>
        ...
        <?php echo wpl_global::include_google_recaptcha('gre_user_contact_activity'); ?>
