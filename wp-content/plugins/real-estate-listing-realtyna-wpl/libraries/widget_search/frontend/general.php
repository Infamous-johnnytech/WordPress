...
elseif($type == 'feature' and !$done_this)
{
    ...
    elseif($show == 'options')
	{
        ...
        foreach($options['values'] as $option)
        {
	        ...
	        $html .= '<option value="'.esc_attr($option['key']).'" '.(in_array($option['key'], $current_value) ? 'selected="selected"' : '').'>'.__($option['value'], 'real-estate-listing-realtyna-wpl').'</option>';
        }
...
elseif($type == 'listings' and !$done_this)
{
	...
	if($show == 'select')
	{
		...
		foreach($listings as $listing)
		{
			...
			$html .= '<option value="'.esc_attr($listing['id']).'" '.($current_value == $listing['id'] ? 'selected="selected"' : '').'>'.__($listing['name'], 'real-estate-listing-realtyna-wpl').'</option>';
		}
	...
	elseif($show == 'multiple')
    {
        ...
        foreach($listings as $listing)
		{
            ...
            $html .= '<option value="'.esc_attr($listing['id']).'" '.(in_array($listing['id'], $current_values) ? 'selected="selected"' : '').'>'.__($listing['name'], 'real-estate-listing-realtyna-wpl').'</option>';
        }
	...
	elseif($show == 'select-predefined')
	{
		...
		foreach($listings as $listing)
		{
			...
			if(is_array($field['extoption']) and in_array($listing['id'], $field['extoption'])) $html .= '<option value="'.esc_attr($listing['id']).'" '.($current_value == $listing['id'] ? 'selected="selected"' : '').'>'.__($listing['name'], 'real-estate-listing-realtyna-wpl').'</option>';
		}
...
elseif($type == 'number' and !$done_this)
{
	...
	if($show == 'text')
	{
    	...
    	$html .= '<input name="sf'.$widget_id.'_text_'.$field_data['table_column'].'" type="text" id="sf'.$widget_id.'_text_'.$field_data['table_column'].'" value="'.esc_attr($current_value).'" placeholder="'.__($field['name'], 'real-estate-listing-realtyna-wpl').'" />';
	}
	elseif($show == 'exacttext')
	{
    	...
    	$html .= '<input name="sf'.$widget_id.'_select_'.$field_data['table_column'].'" type="text" id="sf'.$widget_id.'_select_'.$field_data['table_column'].'" value="'.esc_attr($current_value).'"  placeholder="'.__($field['name'], 'real-estate-listing-realtyna-wpl').'"/>';
	}
    elseif($show == 'minmax')
    {
		...
		$html .= '<input name="sf'.$widget_id.'_tmin_'.$field_data['table_column'].'" type="text" id="sf'.$widget_id.'_tmin_'.$field_data['table_column'].'" value="'.(trim(wpl_request::getVar('sf_tmin_'.$field_data['table_column'])) != '' ? esc_attr($current_min_value) : (isset($extoptions[0]) ? $extoptions[0] : '')).'" placeholder="'.__('Min', 'real-estate-listing-realtyna-wpl').'" />';
		...
		$html .= '<input name="sf'.$widget_id.'_tmax_'.$field_data['table_column'].'" type="text" id="sf'.$widget_id.'_tmax_'.$field_data['table_column'].'" value="'.(trim(wpl_request::getVar('sf_tmax_'.$field_data['table_column'])) != '' ? esc_attr($current_max_value) : (isset($extoptions[1]) ? $extoptions[1] : '')).'" placeholder="'.__('Max', 'real-estate-listing-realtyna-wpl').'" />';
	}
...
elseif(($type == 'price' or $type == 'mmprice') and !$done_this)
{
	...
	if($division!=1) while(($max_value - $min_value) / $division > 5000) $division *= 10;
	...
	if($show == 'minmax')
	{
		...
		if($input_type == 'number') $html .= '<label id="wpl_search_widget_from_label'.$widget_id.'" class="wpl_search_widget_from_label" for="sf'.$widget_id.'_min_'.$min_column.'">'.sprintf(__('Min %s', 'real-estate-listing-realtyna-wpl'), $field_data['name']).'</label>';
		$html .= '<input name="sf'.$widget_id.'_min_'.$min_column.'" type="'.$input_type.'" id="sf'.$widget_id.'_min_'.$min_column.'" step="'.$division.'" min="'.$min_value.'" value="'.$current_min_value.'" placeholder="'.sprintf(__('Min %s', 'real-estate-listing-realtyna-wpl'), __($field_data['name'], 'real-estate-listing-realtyna-wpl')).'" />';
        
		if($input_type == 'number') $html .= '<label id="wpl_search_widget_to_label'.$widget_id.'" class="wpl_search_widget_to_label" for="sf'.$widget_id.'_max_'.$max_column.'">'.sprintf(__('Max %s', 'real-estate-listing-realtyna-wpl'), $field_data['name']).'</label>';
		$html .= '<input name="sf'.$widget_id.'_max_'.$max_column.'" type="'.$input_type.'" id="sf'.$widget_id.'_max_'.$max_column.'" step="'.$division.'" min="'.$min_value.'" value="'.$current_max_value.'" placeholder="'.sprintf(__('Max %s', 'real-estate-listing-realtyna-wpl'), __($field_data['name'], 'real-estate-listing-realtyna-wpl')).'" />';
	}
	elseif($show == 'minmax_slider')
	{
...
elseif(($type == 'area' or $type == 'mmarea' or $type == 'volume' or $type == 'mmvolume' or $type == 'length' or $type == 'mmlength') and !$done_this)
{
	...
	if($show == 'minmax')
	{
		if($input_type == 'number') $html .= '<label id="wpl_search_widget_from_label'.$widget_id.'" class="wpl_search_widget_from_label" for="sf'.$widget_id.'_min_'.$field_data['table_column'].'">'.__('Min', 'real-estate-listing-realtyna-wpl').'</label>';
		$html .= '<input name="sf'.$widget_id.'_min_'.$min_column.'" type="'.$input_type.'" id="sf'.$widget_id.'_min_'.$min_column.'" step="'.$division.'" min="'.$min_value.'" value="'.(trim(wpl_request::getVar('sf_min_'.$min_column)) != '' ? $current_min_value : (isset($extoptions[0]) ? $extoptions[0] : '')).'" placeholder="'.__('Min', 'real-estate-listing-realtyna-wpl').'" />';
        
		if($input_type == 'number') $html .= '<label id="wpl_search_widget_to_label'.$widget_id.'" class="wpl_search_widget_to_label" for="sf'.$widget_id.'_max_'.$field_data['table_column'].'">'.__('Max', 'real-estate-listing-realtyna-wpl').'</label>';
		$html .= '<input name="sf'.$widget_id.'_max_'.$max_column.'" type="'.$input_type.'" id="sf'.$widget_id.'_max_'.$max_column.'" step="'.$division.'" min="'.$min_value.'" value="'.(trim(wpl_request::getVar('sf_max_'.$max_column)) != '' ? $current_max_value : (isset($extoptions[1]) ? $extoptions[1] : '')).'" placeholder="'.__('Max', 'real-estate-listing-realtyna-wpl').'" />';
	}
	elseif($show == 'minmax_slider')
	{
        wpl_html::set_footer('<script type="text/javascript">
...
elseif($type == 'text' and !$done_this)
{
    ...
    else
    {
        $html .= '<label for="sf'.$widget_id.'_'.$query_type.'_'.$field_data['table_column'].'">'.__($field['name'], 'real-estate-listing-realtyna-wpl').'</label>
				<input name="sf'.$widget_id.'_'.$query_type.'_'.$field_data['table_column'].'" type="text" id="sf'.$widget_id.'_'.$query_type.'_'.$field_data['table_column'].'" value="'.esc_attr($current_value).'" placeholder="'.__($field['name'], 'real-estate-listing-realtyna-wpl').'" />';
    }
...
elseif($type == 'textsearch' and !$done_this)
{
	...
	if($show == 'text')
	{
		$html .= '<input value="'.esc_attr($current_value).'" name="sf'.$widget_id.'_textsearch_'.$field_data['table_column'].'" type="text" id="sf'.$widget_id.'_textsearch_'.$field_data['table_column'].'" placeholder="'.__($field['name'], 'real-estate-listing-realtyna-wpl').'" />';
	}
