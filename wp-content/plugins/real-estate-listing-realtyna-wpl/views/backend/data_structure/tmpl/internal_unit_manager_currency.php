			...
			<tr id="item_row_<?php echo $unit['id']; ?>">
				...
				<td>
					<select class="selectbox" data-wpl-id="<?php echo $unit['id']; ?>" data-wpl-option="seperator" onchange="wpl_change_unit_option(this);">
						...
						<option value="space" <?php if(strlen($unit['seperator']) == 2) echo 'selected="selected"'; ?>> <?php echo __('Space', 'real-estate-listing-realtyna-wpl'); ?></option>
						<option value="double space" <?php if(strlen($unit['seperator']) == 4) echo 'selected="selected"'; ?>> <?php echo __('Double Space', 'real-estate-listing-realtyna-wpl'); ?></option>
					</select>
					<span class="wpl-loader"></span>
				</td>
				<td>
