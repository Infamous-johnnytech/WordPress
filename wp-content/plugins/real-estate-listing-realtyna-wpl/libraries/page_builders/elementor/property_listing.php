...
class wpl_page_builders_elementor_property_listing extends \Elementor\Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $listings_options[''] = esc_html__('Any', 'real-estate-listing-realtyna-wpl');
        ...
        $property_types_options[''] = esc_html__('Any', 'real-estate-listing-realtyna-wpl');
        ...
        $wpl_users_options[''] = esc_html__('Any', 'real-estate-listing-realtyna-wpl');
        ...
        $layouts_options[''] = esc_html__('-----', 'real-estate-listing-realtyna-wpl');
        ...
        $pages_options = array();
        $pages_options[''] = esc_html__('-----', 'real-estate-listing-realtyna-wpl');
