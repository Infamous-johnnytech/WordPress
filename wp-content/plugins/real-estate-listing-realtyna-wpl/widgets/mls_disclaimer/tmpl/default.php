...
<div id="wpl_mls_disclaimer_widget_cnt<?php echo $this->widget_id; ?>" class="wpl-mls_disclaimer-widget <?php echo $this->css_class; ?>">
    ...
    <div class="mls-disclaimer-right">
        ...
        <div class="mls-last-update"><?php echo sprintf(__('Data last updated: %s', 'real-estate-listing-realtyna-wpl'), (($last_updated_date and $last_updated_date != '0000-00-00') ? date('m/d/Y g:i', strtotime($last_updated_date)) : __('Unknown', 'real-estate-listing-realtyna-wpl'))); ?></div>
        <?php endif; ?>
    </div>
</div>