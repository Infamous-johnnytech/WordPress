...
var markers_array<?php echo $this->activity_id; ?> = [];
var loaded_markers<?php echo $this->activity_id; ?> = [];
...
var wpl_map_search_limit<?php echo $this->activity_id; ?> = <?php echo $wpl_map_search_limit ?>;
var wpl_found_properties<?php echo $this->activity_id; ?> = <?php echo (isset($this->found_properties_count) and $this->found_properties_count) ? $this->found_properties_count : 0; ?>;
...
function wpl_initialize<?php echo $this->activity_id; ?>()
{
	...
	if(wpl_map_search_limit<?php echo $this->activity_id; ?> > 0 && (<?php echo $wpl_map_current_page ?> > 1 || !markers<?php echo $this->activity_id; ?> || (wpl_found_properties<?php echo $this->activity_id; ?> >= <?php echo $wpl_map_current_limit ?>))) load_markers_on_init = true;

	/** load markers **/
    if(load_markers_on_init)
    {
        // just for loading map
        wpl_load_markers<?php echo $this->activity_id; ?>([]);
    }
    else wpl_load_markers<?php echo $this->activity_id; ?>(markers<?php echo $this->activity_id; ?>);
    ...
    if(load_markers_on_init)
    {
        setTimeout(function()
        {
            var request_string = '<?php echo http_build_query($_GET); ?>';
...
function wpl_load_map_markers(request_str, delete_markers)
{
    ...
    if(wpl_map_search_limit<?php echo $this->activity_id; ?> > 0)
    {
        var current_page = <?php echo $wpl_map_current_page; ?>;
        var current_limit = <?php echo $wpl_map_current_limit; ?>;
        url = '<?php echo wpl_global::remove_qs_var('wplpage', wpl_global::remove_qs_var('limit', wpl_global::get_full_url())); ?>';
        request_str = wpl_update_qs('limit', wpl_map_search_limit<?php echo $this->activity_id; ?>, request_str);
        var map_page = Math.ceil((current_page * current_limit ) / wpl_map_search_limit<?php echo $this->activity_id; ?>);
