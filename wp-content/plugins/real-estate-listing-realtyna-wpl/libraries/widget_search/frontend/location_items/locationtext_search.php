...
if($show == 'locationtextsearch' and !$done_this)
{
	...
	$html .= '<input class="wpl_search_widget_location_textsearch" value="'.esc_attr($current_value).'" name="sf'.$widget_id.'_locationtextsearch" id="sf'.$widget_id.'_locationtextsearch" placeholder="'.__($placeholder, 'real-estate-listing-realtyna-wpl').'" />';
