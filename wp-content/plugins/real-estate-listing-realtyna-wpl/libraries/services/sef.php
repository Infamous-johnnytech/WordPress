...
class wpl_service_sef
{
    ...
    public function remove_canonical()
    {
        ...
        add_filter('aioseo_twitter_tags', '__return_false'); // twitter tags
        add_filter('aioseo_facebook_tags', '__return_false'); // og tags
        add_filter('aioseo_canonical_url', '__return_false'); // aioseo_canonical_url
    }
