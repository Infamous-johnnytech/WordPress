...
class wpl_wpl_controller extends wpl_controller
{
	...
	private function update_package()
	{
		...
		$zip_file = wpl_global::get_web_page('https://billing.realtyna.com/index.php?option=com_rls&view=downloadables&task=download&sid='.$sid.'&randomkey='.rand(1, 100));
	...
	private function save_realtyna_credentials()
	{
		...
		$response = wpl_global::check_realtyna_credentials($username, $password);
		$this->response($response);
	}	
