        ...
        <table class="widefat page" id="wpl_notification_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="wpl_notification_subject"><a href="<?php echo wpl_global::add_qs_var('tpl', 'modify'); ?>&id=<?php echo $notification->id; ?>"><?php echo (trim($notification->{$subject_column}) ? $notification->{$subject_column} : __('Edit', 'real-estate-listing-realtyna-wpl')); ?></a></td>
