        ...
        <div class="panel-body">
            ...
            <div class="wpl-addons-install-wp wpl_install_addons_container">
                <div class="wpl_realtyna_credentials_container">
                    ...
                    <br/>
                    <span class="wpl_realtyna_credentials_tip"><?php echo __('Your username and password in Realtyna Billing system is necessary for Premium Support and Add-on updates!', 'real-estate-listing-realtyna-wpl'); ?></span>
                </div>

                <?php if($this->settings['realtyna_verified'] == 0): ?>             
                    <?php if(!isset($this->settings['realtyna_envato_purchase'])): ?>
                        <div class="wpl_realtyna_envato_container_drop" onclick="dropdown_envato_purchase_form();"><?php echo __('Did you buy WPL from <i>CodeCanyon</i>? Click Here to get your username and password.', 'real-estate-listing-realtyna-wpl'); ?></div>
